...
var (
	httpRequestsTotal = promauto.NewCounterVec(
		prometheus.CounterOpts{
			Name: "diabrisk_auth_svc_http_requests_total",
			Help: "Total number of HTTP requests handled by auth-svc.",
		},
	...
	httpRequestDurationSeconds = promauto.NewHistogramVec(
		prometheus.HistogramOpts{
			Name:    "diabrisk_auth_svc_http_request_duration_seconds",
			Help:    "HTTP request duration in seconds for auth-svc.",
	...
	httpResponseSizeBytes = promauto.NewHistogramVec(
		prometheus.HistogramOpts{
			Name:    "diabrisk_auth_svc_http_response_size_bytes",
			Help:    "HTTP response size in bytes for auth-svc.",
